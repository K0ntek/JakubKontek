...
const Contact = () => {
  ...
  return (
    ...
    <div className=' max-w-[800px] lg:w-full mx-auto bg-gradient-to-r from-[rgba(255,149,73,.9)] to-[rgba(208,89,91,.9)] rounded-[40px] p-10'>
            <div className='relative top-[50%] translate-y-[-50%] mx-auto max-w-[500px]'>
                <div className=' space-y-3 font-montserrat font-[500]'>
                <h1 className=' font-montserrat text-5xl font-[600] mt-1 mb-6'>Stwórzmy razem coś fajnego!</h1>

                        <div>
                            <div className="flex space-x-2 ">
                                <MdEmail className=' mt-2 text-xl rounded-full'/>
                                <p className='text-2xl mt-1'>Napisz</p>
                            </div>
                            <p className=' ml-5 font-montserrat font-[500] text-xl'>jakub.kontek05@gmail.com</p>
                        </div>
                        
                      <div>
                            <div className="flex space-x-2">
                                <FaPhoneAlt className=' mt-2 text-xl rounded-full'/>
                                <p className='text-2xl mt-1'>Zadzwoń</p>
                            </div>
                            <p className=' ml-5 font-montserrat font-[500] text-xl'> +48 790 839 086</p>
                      </div>
